...
public class MyTipDialogSetText extends AlertDialog {
    ...
    private SpannableString mDialogContent;
    private String mBtSYesText, mBtSNoText, mDialogTitle, mSelfBtText;
    ...
    public MyTipDialogSetText(Context context) {
        super(context, R.style.MyDialog);
    }

    public MyTipDialogSetText(Context context, int themeResId) {
     ...
     * 弹窗内容设置
     */
    public void setDialogContent(SpannableString dialogContent) {
