...
public class FloatWindowOption {
    ...
    private FloatWindow.FloatMoveEnum mMoveType;
    ...
    private FloatWindowOption(Builder builder) {
        ...
        this.mMoveType = builder.mMoveType != null ? builder.mMoveType : FloatWindow.FloatMoveEnum.INACTIVE;
    ...
    public FloatWindow.FloatMoveEnum getMoveType() {
        return mMoveType;
    }
    ...
    public static class Builder {
        ...
        public Builder setFloatMoveType(FloatWindow.FloatMoveEnum moveType) {
